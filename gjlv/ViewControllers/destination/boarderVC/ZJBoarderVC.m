...
-(void)getHotels{
    ...
    [[ZJNetWorkingHelper shareNetWork]getHotelList:@{@"userId":ZJ_UserID,@"destId":self.mSelectModel.mdestId,@"lat":latStr,@"lng":lngStr,@"pageIndex":[NSString stringWithFormat:@"%ld",self.pageIndex],@"pageSize":[NSString stringWithFormat:@"%ld",self.pageSize]} SuccessBlock:^(id responseBody) {
        NSError *error;
